...
<div class="container-fluid">
    ...
    <!-- Brand -->
    <a class="navbar-brand pt-0" href="{{ route('ae.home') }}">
    ...
    <ul class="nav align-items-center d-md-none">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                ...
                <a href=href="{{ route('ae.profile.edit') }}" class="dropdown-item">
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <ul class="navbar-nav">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('ae.home') }}">
            ...
            <li class="nav-item">
                ...
                <div class="collapse show" id="navbar-examples">
                    <ul class="nav nav-sm flex-column">
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('ae.profile.edit') }}">
                                User profile
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('ae.user.index') }}">
                                User Management
                            </a>
                        </li>
                    </ul>
...
<div class="container-fluid">
    <!-- Brand -->
    <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="{{ route('ae.home') }}">Dashboard</a>
    <!-- Form -->
    ...
    <ul class="navbar-nav align-items-center d-none d-md-flex">
        <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                ...
                <a href="{{ route('ae.profile.edit') }}" class="dropdown-item">
                    <i class="ni ni-single-02"></i>
                    <span>My profile</span>
                </a>
                <a href="#" class="dropdown-item">
