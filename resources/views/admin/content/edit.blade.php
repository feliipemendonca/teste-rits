        ...
        <div class="row">
            <div class="col">
                <div class="card shadow">
                   ...
                   <div class="card-body">
                        <form action="{{ route('admin.conteudo.update', $content->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-12 col-md-7">
                                    <div class="form-row">
                                        <div class="form-group col-12 @error('title') has-danger @enderror">
                                            ...
                                            <input class="form-control @error('title')is-invalid @enderror" placeholder="Título" type="text" name="title" value="{{ $content->title }}">
                                            @error('title') <div class="invalid-feedback d-block"> {!! $message !!} </div>  @enderror
                                        </div>
                                        <div class="form-group col-12 @error('subtitle') has-danger @enderror">
                                            <label for="products">Subtitulo</label>
                                            <input class="form-control @error('subtitle')is-invalid @enderror" placeholder="Subititulo" type="text" name="subtitle" value="{{ $content->subtitle }}">
                                        ...
                                        <div class="form-group col-12 @error('video') has-danger @enderror">
                                            ...
                                            <input class="form-control @error('video')is-invalid @enderror" placeholder="Subititulo" type="text" name="video" value="{{ $content->video }}">
                                        ...
                                        <div class="col-12 @error('content') has-danger @enderror">
                                            ...
                                            <textarea name="content" class="@error('content')is-invalid @enderror" id="content" cols="30" rows="10">{{ $content->content }}</textarea>
                                ...
                                <div class="col-12 col-md-5">
                                    <div class="form-group @error('image') has-danger @enderror">
                                        ...
                                        <img  id="imagem" class="img-fluid" src="{{ asset($content->files->filename) }}">
                                    </div>
                                </div>
                            </div>
